...
import type {
  GetItemByIdAppRequestDto,
  GetItemByIdAppResponseDto,
  GetItemsBySearchQueryAppRequestDto,
  GetItemsBySearchQueryAppResponseDto,
} from "../dtos";
...
export class ItemsUseCasesService {
  ...
  async getItemsBySearchQuery({
    searchQuery,
  }: GetItemsBySearchQueryAppRequestDto): Promise<GetItemsBySearchQueryAppResponseDto> {
  ...
  async getItemById({
    itemId,
  }: GetItemByIdAppRequestDto): Promise<GetItemByIdAppResponseDto> {
